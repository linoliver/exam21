  ...
  <div class="dingdan">
    ...
    <div class="list">
      <div class="list_one">
        ...
        <div class="right" @click="changebook">
          换驾照
      ...
      <div class="list_one">
        <div class="left">
          当前驾照签发城市
          <i class="icon iconfont icon-wenhao_huabanfuben"></i>
        </div>
        <div class="right">
          <span @click="WriteCity">请选择签发地</span>
        </div>
      </div>
      <div class="list_one">
        <div class="left">
        ...
        <div class="right">
          <span @click="WriteCity">请选择补换地</span>
        </div>
      </div>
    ...
    <div class="lists">
      <div class="lists_vip">
        <div class="left">
          <span class="span1">成为车轮会员</span>
          <span class="span2">每年省￥2000+，本单省￥30</span>
        </div>
        <div class="right">
    ...
    <div class="writecity">
      <mt-popup v-model="writecity_popupVisible" position="bottom">
...
export default {
  ...
  methods: {
    ...
    CameraParentFn(e) {
      ...
      //   console.log(v)
      // })
      console.log("wode", this.CityList);
    },
    Photograph() {
      console.log("拍照");
    },
